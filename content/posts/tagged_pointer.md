...
ABC项目是berkeley开发的开源逻辑综合工具，在其核心数据结构AIG的实现中，节点对象[Aig_Obj_t](https://github.com/berkeley-abc/abc/blob/master/src/aig/aig/aig.h)使用tagged pointer优化，利用最低1位存储complement(反相)标记。在大规模电路网表中，这种优化的收益是显著的。
